...
// Ensure L is on window so any legacy references or child scripts can access it
if (typeof window !== "undefined") {
  (window as any).L = L;
}

// Add the gestureHandling handler to L Map class
if (L && L.Map) {
  L.Map.addInitHook("addHandler", "gestureHandling", GestureHandling);
}

import { getGroupColor, getArcPoints, generateFallbackGeoJSON, airportCoordinates, targetRegions, activeRegions, mapLocations, flightRoutes } from "../constants";
...
export const InteractiveDemographicMap = memo(() => {
  ...
  useEffect(() => {
    ...
    syncRegionBorders(map as any, activeRegions);
                                  ...
                                  {expandedSubGroups[subGroupName] !==
                                    ...
                                    <div className="flex flex-col mb-1">
                                      ...
                                      {expandedSubGroups[
                                        ...
                                        isDistanceFolder &&
                                        subGroupLocs
                                          .filter((l) => (l as any).tier === "Class B")
                                          .map((loc, index) => (
                                            <div
                                              key={loc.id}
