...
export const AssetCascadeView = memo(
  ({ data, onExport, viewResolution, setViewResolution }) => {
    ...
    const [isCascadeHardExpanded, setIsCascadeHardExpanded] =
      React.useState(true);
    const [isCascadeSoftExpanded, setIsCascadeSoftExpanded] = React.useState(true);
    const [isCascadePreOpCapexExpanded, setIsCascadePreOpCapexExpanded] = React.useState(true);
                      ...
                      {((data.totals?.devGa || 0) + (data.totals?.devCar || 0) + (data.totals?.devPreOpening || 0)) > 0 && (
                        <>
                          <TableRow
                            ...
                            isExpandable
                            isExpanded={isCascadePreOpCapexExpanded}
                            onExpand={() => setIsCascadePreOpCapexExpanded(!isCascadePreOpCapexExpanded)}
                          />
                          {isCascadePreOpCapexExpanded && (
                            <>
